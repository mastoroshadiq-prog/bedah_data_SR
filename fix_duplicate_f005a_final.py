"""
Fix Duplicate F005A (Final)
1. Revert existing block ID 112 to AME (Div 2)
2. Create NEW block F005A for OLE (Div 6) with minimal payload
...
print("FIX DUPLICATE F005A (FINAL)")
print("="*60)
...
if not ole_block:
    try:
        new_b = {
            ...
            'division_id': 6  # ONLY THIS + block_code
        }
